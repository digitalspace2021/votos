...
@section('cabecera')
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
        <h1 class="display-4 fw-normal">Nuevo candidato</h1>
    </div>
@endsection
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-7">
                ...
                <form class="needs-validation" method="POST" action="{{ route('candidatos.crear.guardar') }}" novalidate>
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" id="identifcacion" name="identifcacion"
