                        ...
                        <nav class="nav flex-column">
                            @auth
                                ...
                                @if (Auth::user()->hasRole('administrador'))
                                    ...
                                    <a class="me-3 py-2 text-dark text-decoration-none btn-hover"
                                        href="{{ route('users-edils.index', ['type' => 'Edil']) }}"><i class="fa fa-user-plus" aria-hidden="true"></i> Ediles</a>
                                    <a class="me-3 py-2 text-dark text-decoration-none btn-hover"
                                        href="{{ route('users-edils.index', ['type' => 'Asambleista']) }}"><i class="fa fa-user-plus" aria-hidden="true"></i> Asambleista</a>
                                @endif
                                @if (Auth::user()->hasRole('administrador'))
