            ...
            <div class="row">
                <div class="col-md-12 mb-2">
                    ...
                    <input type="number" name="identificacion" id="" class="form-control"
                        value="{{$edil->identificacion}}" required>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" name="nombres" value="{{$edil->nombres}}" required>
                    @error('nombres')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" name="apellidos" value="{{$edil->apellidos}}" required>
                    @error('apellidos')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="email" class="form-control" name="email" value="{{$edil->email}}" required>
                    @error('email')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" name="direccion" value="{{$edil->direccion}}" required>
                    @error('direccion')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="descripcion" id="" cols="30" rows="5" class="form-control"
                        required>{{$edil->descripcion}}</textarea>
                    @error('descripcion')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
