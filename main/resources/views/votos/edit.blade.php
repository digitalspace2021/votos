...
<div class="pricing-header p-3 pb-md-4 mx-auto text-center">
    <h1 class="display-4 fw-normal">Editar voto</h1>
</div>
...
<div class="container">
    ...
    <div class="d-flex justify-content-center align-items-center w-75" style="margin-left: auto; margin-right: auto; flex-direction:column;">
        <form action="{{route('votos.update', ['id'=>$voto->id])}}" method="POST" enctype="multipart/form-data" id="createProblem">
            @method('PUT')
            @csrf
            <div class="row">
                @error('form_id')
                ...
                @enderror
                <input type="hidden" name="form_id" value="{{$voto->form->id}}">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" value="{{$voto->form->creador->name}}" id="registrador" disabled>
                </div>
                <div class="col-md-6 mb-2">
                    <label for="email" class="form-label">Fecha de Formulario</label>
                    <input type="email" class="form-control" value="{{$voto->form->created_at}}" id="fecha_creacion" disabled>
                </div>
                <div class="col-md-6 mb-2">
                    <label for="telefono" class="form-label">Comuna</label>
                    <input type="text" class="form-control" value="{{$voto->form->ubicacion()}}" id="ubicacion" disabled>
                </div>
                <div class="col-md-6 mb-2">
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex justify-content-center align-items-center">
                    ...
                    <input type="radio" name="voto" id="voto" value="si" class="form-check-input"
                        @if ($voto->voto == true)
                            checked
                        @endif
                    required>
                ...
                <div class="col-md-6 d-flex justify-content-center align-items-center">
                    ...
                    <input type="radio" name="voto" id="voto" value="no" class="form-check-input"
                        @if ($voto->voto == false)
                            checked
                        @endif
                    required>
            ...
            <div class="row mt-3">
                <div class="col-md-12 d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-success" id="btnSave">Actualizar</button>
                </div>
            </div>
        </form>
    </div>
