...
--
-- Host: 127.0.0.1    Database: clean_politicos
-- ------------------------------------------------------
...
CREATE TABLE `ediles` (
  ...
  CONSTRAINT `ediles_edil_id_foreign` FOREIGN KEY (`edil_id`) REFERENCES `usuarios_ediles` (`id`),
  CONSTRAINT `ediles_formulario_id_foreign` FOREIGN KEY (`formulario_id`) REFERENCES `formularios` (`id`)
...
INSERT INTO `model_has_roles` VALUES (1,'App\\Models\\User',1),(2,'App\\Models\\User',2),(1,'App\\Models\\User',3),(2,'App\\Models\\User',4),(2,'App\\Models\\User',5);
...
-- Dump completed on 2023-07-18 14:44:49
