...
INSERT INTO `candidatos` VALUES (1,'Nora Hendricks','Sit pariatur Quo s','Dolor sit hic magni','Aut excepturi laudan',3,' ','2023-07-08 01:42:30','2023-07-08 01:42:30');
...
INSERT INTO `formularios` VALUES (3,2,'Labore voluptate exe','Id alias perferendis','pifihan@mailinator.com','Sint qui excepteur p','Mujer','Itaque id exercitati',NULL,'74','33 sdadasdwww','2023-07-08 18:42:35','2023-07-08 18:42:35',NULL,NULL,'9513212544','Nam est libero possi',0),(4,2,'Proident aliqua Ma','Debitis debitis aspe','ragixo@mailinator.com','Autem in soluta Nam','Mujer','Sint iusto sed quis','5','67',NULL,'2023-07-08 19:06:27','2023-07-12 00:47:19','Corregimiento',1,'4823232324','Id nemo est labore',1);
...
CREATE TABLE `matriz_seguimiento` (
  ...
  `fechas_cuatro` json NOT NULL,
  `respuesta_cinco` tinyint(1) NOT NULL,
  `fechas_cinco` json NOT NULL,
  `respuesta_seis` tinyint(1) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,'Admin','admin@app.com',NULL,'$2y$10$6vMVk2yXYzrRJBxpdYnjFOXees9gBfikpieSNcyaxwNPBxwTd9Qgy',NULL,'2023-07-08 01:24:36','2023-07-08 01:24:36'),(2,'simple','simple@app.com',NULL,'$2y$10$Tv2hZ7RXz.QdmK/O9BbTQ.8lWLIYgq1LaqsUkOQHZZ4V8Mleza6LK',NULL,'2023-07-08 01:24:36','2023-07-08 01:24:36');
...
-- Dump completed on 2023-07-11 16:48:22
